...
karte.on("load zoomend moveend", function () {
    ...
    const geonamesUrl = `https://api.geonames.org/wikipediaBoundingBoxJSON?formatted=true&north=${ausschnitt.n}&south=${ausschnitt.s}&east=${ausschnitt.o}&west=${ausschnitt.w}&username=elleluk&style=full&maxRows=50&lang=de`;
